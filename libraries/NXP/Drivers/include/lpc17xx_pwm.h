...
/** PWM1 ouput function pin selection group 0 */
#define PWM1_1_PINSEL_P1_18		{1, 18, 2, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}
#define PWM1_2_PINSEL_P1_20		{1, 20, 2, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}
#define PWM1_3_PINSEL_P1_21		{1, 21, 2, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}
#define PWM1_4_PINSEL_P1_23		{1, 23, 2, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}
#define PWM1_5_PINSEL_P1_24		{1, 24, 2, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}
#define PWM1_6_PINSEL_P1_26		{1, 26, 2, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}

/** PWM1 ouput function pin selection group 1 */
#define PWM1_1_PINSEL_P2_0		{2, 0, 1, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}
#define PWM1_2_PINSEL_P2_1		{2, 1, 1, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}
#define PWM1_3_PINSEL_P2_2		{2, 2, 1, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}
#define PWM1_4_PINSEL_P2_3		{2, 3, 1, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}
#define PWM1_5_PINSEL_P2_4		{2, 4, 1, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}
#define PWM1_6_PINSEL_P2_5		{2, 5, 1, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}

/** PWM1 - Capture input pin */
#define PWM1_PINSEL_CAP0_P1_18	{1, 18, 3, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}

#define PWM1_PINSEL_CAP1_P1_19	{1, 19, 3, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}

/** PWM1 - P Capture input pin */
#define PWM1_PINSEL_PCAP0_P1_28	{1, 28, 2, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}

#define PWM1_PINSEL_PCAP1_P1_29	{1, 29, 2, \
								PINSEL_PINMODE_PULLUP, \
								PINSEL_PINMODE_NORMAL}
...
#define PWM1_1_MAX_PIN	(2)
#define PWM1_2_MAX_PIN	(2)
#define PWM1_3_MAX_PIN	(2)
#define PWM1_4_MAX_PIN	(2)
#define PWM1_5_MAX_PIN	(2)
#define PWM1_6_MAX_PIN	(2)
#define	PWM1_CAP0_MAX_PIN	(1)
#define	PWM1_CAP1_MAX_PIN	(1)
#define	PWM1_PCAP0_MAX_PIN	(1)
#define	PWM1_PCAP1_MAX_PIN	(1)
/**
 * @}
 */

/** @defgroup PWM_REGISTER_BIT_ DEFINITIONS
 * @{
 */
...
typedef struct {
	...
	uint8_t CountInputSelect;	/**< Counter input select, should be:
								...
								*/
	uint8_t CountInputPinConfigState; 	/**< Count Input Pin configuration state,
										should be:
										- ENABLE: Count Input Pin function will be configured
										corresponding to this function.
										- DISABLE: Count Input Pin function will not be configured
										corresponding to this function.
										*/
	uint8_t Reserved[1];
} PWM_COUNTERCFG_Type;
...
typedef struct {
	...
	uint8_t IntOnCaption;	/**< Interrupt On caption, should be:
							...
							- DISABLE: Disable this function.
							*/
	uint8_t CapPinConfigState;	/**< Input Capture Pin configuration state,
									should be:
									- ENABLE: Input Capture pin function will be configured
									corresponding to this function.
									- DISABLE: Input Capture pin function will not be configured
									corresponding to this function.
									*/
	uint8_t Reserved[3];
} PWM_CAPTURECFG_Type;
...
/** PWM1 Pin configuration definitions */
#define PWM1_1_P1_18		((uint8_t)(0))
#define PWM1_1_P2_0			((uint8_t)(1))
#define PARAM_PWM1_1_PIN(n)	((n==0) || (n==1))

#define PWM1_2_P1_20		((uint8_t)(0))
#define PWM1_2_P2_1			((uint8_t)(1))
#define PARAM_PWM1_2_PIN(n)	((n==0) || (n==1))

#define PWM1_3_P1_21		((uint8_t)(0))
#define PWM1_3_P2_2			((uint8_t)(1))
#define PARAM_PWM1_3_PIN(n)	((n==0) || (n==1))

#define PWM1_4_P1_23		((uint8_t)(0))
#define PWM1_4_P2_3			((uint8_t)(1))
#define PARAM_PWM1_4_PIN(n)	((n==0) || (n==1))

#define PWM1_5_P1_24		((uint8_t)(0))
#define PWM1_5_P2_4			((uint8_t)(1))
#define PARAM_PWM1_5_PIN(n)	((n==0) || (n==1))

#define PWM1_6_P1_26		((uint8_t)(0))
#define PWM1_6_P2_5			((uint8_t)(1))
#define PARAM_PWM1_6_PIN(n)	((n==0) || (n==1))
