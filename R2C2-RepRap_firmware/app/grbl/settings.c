...
settings_t settings =
{
  {86, 86, 2560}, // steps per mm
  1,        // microsteps (not used?)
  5,        // step pulse width (microsec)
  600.0,    // default feed rate (mm/min)
  600.0,    // default seek rate-fast (mm/min)
  0,        // invert mask (what for?)
  0.1,      // mm/arc seg
  500.0,    // accel (mm/s^2)
  0.05      // junction deviation (mm)
};
